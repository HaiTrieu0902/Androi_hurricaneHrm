...
import { IChangeAuth } from 'src/types/auth';
...
const ChangePassword = () => {
    ...
    const [valueForm, setValueForm] = useState<IChangeAuth>({
        currentPassword: '',
        newPassword: '',
        confirmPassword: '',
    });
    const [validationErrors, setValidationErrors] = useState<IChangeAuth>({
        currentPassword: '',
        newPassword: '',
        confirmPassword: '',
    });
    ...
    return (
        <SafeAreaView style={styles.bg_scrren}>
            ...
            <View style={styles.view_form_container}>
                ...
                <View style={styles.view_form}>
                    <View style={styles.view_form_left}>
                        <FontAwesome6 name="key" size={SIZE_ICON_16} color={'black'}>
                            {' '}
                        </FontAwesome6>
                        <TextInput
                ...
                <View style={styles.btn_confirm}>
                    <ButtonUI bgColor={BG_SUB_COLOR} text="Change" onPress={handleOnSubmit} />
                </View>
            </View>
        </SafeAreaView>
    );
